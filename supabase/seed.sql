...
-- =====================================================================
insert into public.certificates (title, description, file_type, storage_path, url, file_name, author_name)
select '특허증', '', 'image', null, 'theme/home/img/company/cert02.jpg', 'cert02.jpg', '대한수자원'
